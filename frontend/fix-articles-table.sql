-- Fix articles table RLS policies for draft approval
-- This script ensures editors can approve drafts by inserting articles
...
DO $$
BEGIN
    RAISE NOTICE 'Articles and drafts table policies fixed successfully!';
END $$;
